...
\newcommand{\solution}{%
	...
	bottom=5pt, % เพิ่มจาก 2pt เป็น 5pt เพื่อดันฐานกล่องหนีตัวอักษรล่าง
		...
		\begin{tabular}{!{\color{coverblue}\vrule width 5pt} p{\dimexpr\textwidth-25pt}}
			...
			\colorbox{coverblue!10}{
				\begin{minipage}[t]{\dimexpr\textwidth-25pt}
					...
					{\Huge\bfseries\color{covergray} รายวิชาเพิ่มเติม ม.6 เล่ม 2}\\[1.0em]
					{\Large\bfseries\color{covergray} หัวข้อ : ตัวแปรสุ่มและการแจกแจงความน่าจะเป็น}
...
\textit{หนังสือเรียนรายวิชาเพิ่มเติมคณิตศาสตร์ ชั้นมัธยมศึกษาปีที่ 6 เล่ม 2} (พิมพ์ครั้งที่ 2).
